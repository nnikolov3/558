...
public class ClientRational extends Rational  {
	...
	public static void main(String[] args) {
		...
		TestRunner runTest1 = new TestRunner("sum should return 6 when num = 1 and den = 5",sum,6,1);
		runTest1.runner();
		// Test#2
		double multiply = ratObj.multiply();
		TestRunner runTest2 = new TestRunner("multiply should return 5 when num = 1 and den = 5",multiply,5,2);
		runTest2.runner();
		// Test#3
